...
typedef __int64_t __v4ll __attribute__((__vector_size__(32), aligned(32)));
...
/* Unsigned types */
typedef __uint64_t __v4ull __attribute__((__vector_size__(32), aligned(32)));
...
typedef __int64_t __uv4ll __attribute__((__vector_size__(32), aligned(1)));
...
/* Unsigned types */
typedef __uint64_t __uv4ull __attribute__((__vector_size__(32), aligned(1)));
