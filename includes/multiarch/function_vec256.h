...
static inline __SIMPLV_ATTR vec v256b_set_char(
    ...
    return __SIMPLV_FUNC(v256b_set_char)(__a, __b, __c, __d, __e, __f, __g, __h, 
...
static inline __SIMPLV_ATTR int v32c_movemask(vec __a) {
    return __SIMPLV_FUNC(v32c_movemask)(__a);
}
